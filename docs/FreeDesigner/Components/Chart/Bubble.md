...
![气泡图](../../assets/img/configuration_Bubble.png "气泡图"){.img-fluid tag=1}
...
|-----|--------|----|--------|--------|----------|-----|-----|
| 气泡图样式 | 气泡比例 |  | number | 100 | setBubbleSize | getBubbleSize | 允许 |
| 气泡图样式 | 预警 |  | object | { min: undefined, max: undefined, color:'red', enabled:false } | setChartEarly | getChartEarly | 允许 |
| 气泡图样式 | 网格 |  | number | 0 | setShowGrid | getShowGrid | 允许 |
